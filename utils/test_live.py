...
def test(dataloader, net, criterion, optimizer, opt):
    ...
    print("Test  precission_0 :({:.4f}%):".format( 100*precission_zero))
    print("Test  precission_1 :({:.4f}%):".format( 100*precission_one))
    print("Test recall_0 :({:.4f}%):".format( 100*recall_zero))
    print("Test recall_1 :({:.4f}%):".format( 100*recall_one))
    print("Test f1_0 :({:.4f}%):".format( 100*f1_zero))
    print("Test f1_1 :({:.4f}%):".format( 100*f1_one))
