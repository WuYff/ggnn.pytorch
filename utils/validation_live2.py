        ...
        for b in range(len(target)):
            ...
            for x in range(the_max_node ): 
                for m in range (the_def_node ):    
                    ...
                    # print("x,m,n",x,m,n)
                    if  target[b][n]==1 and output[b][n] >= 0.6 : # TP1 true positive for 1
                        correct +=1
                        one_correct +=1
                        TP1+=1
                    if  target[b][n]==0 and output[b][n] < 0.6 : #  TP0 true positve for 0
                        correct +=1
                        zero_correct +=1
                        TP0+=1
                    if  target[b][n]==1:
                        v_one  +=1
                    if  target[b][n]==0 and output[b][n] >= 0.6  : # FP1 false positive for 1, FN0 false negative for 0
                        FP1+=1
                    if  target[b][n]==1 and output[b][n] < 0.6  : # FP0 false postive for 0, FN1 false negative for 1
                        FP0+=1
